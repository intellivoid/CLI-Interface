...
namespace Intellivoid.cli {
	...
	/// <remarks>
	///   <para>
	///     Creates a instance of <see cref="cli.MainLoop"/> to process input events, handle timers and
	...
	///     invoked on each iteration of the <see cref="cli.MainLoop"/>.
	///   </para>
	///   <para>
	...
	public static class Application {
		...
		/// <summary>
		/// Initializes a new instance of <see cref="Intellivoid.cli"/> Application. 
		/// </summary>
		/// <remarks>
		/// <para>
